...
<body>
	<div class="container-fluid">
		<div class="col-sm-9">
			<form action="?mod=post&act=update&id=<?=$post['id']?>" method="POST" role="form">
				<legend><h1 align="center">Update posts</h1></legend>
		        ...
		        <div class="form-group">
		          	...
		          	<div class="col-md-9 col-sm-9" style="padding-bottom: 30px">
		          		<div>
			              	<textarea name="short_content" class="form-control" rows="5"><?= $post['short_content']?></textarea>
		            	</div>
		          	</div>
		        </div>
		        <div class="form-group">
		          	...
		          	<div class="col-md-9 col-sm-9" style="padding-bottom: 30px">
		          		<div >
		            		<textarea name="contents" class="form-control" rows="5"><?= $post['contents']?></textarea>
		            	</div>
		          	</div>
		        </div>
		        <div class="form-group">
				...
				<div class="form-group">
					<div class="col-xs-offset-2 col-xs-10">
						<button type="submit" name="submit" class="btn btn-danger btn-md">Create</button>
					</div>
		        </div>
			</form>
		</div>
