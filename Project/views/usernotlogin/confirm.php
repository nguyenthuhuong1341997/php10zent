<?php 
	...
	$contents=$_SESSION['sign']['random'];
	send_email($_SESSION['sign']['email'],"thao",$contents,'Sign up' );
 ?>
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="public/Signup/fonts/iconic/css/material-design-iconic-font.min.css">
<!--===============================================================================================-->
...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('public/Signup/images/vietnam.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="POST" action="?mod=usernotlogin&act=confirm">
					<span class="login100-form-title p-b-59">
						Confirm 
					</span>
					
					<p>Please check your email for a message with. Your code í 6 numbers long</p>
					<div class="wrap-input100 validate-input" data-validate="">
						<span class="label-input100">Enter security code</span>
						<input class="input100" type="text" name="code" placeholder="Enter code...">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<!-- <a href="" class="btn btn-link" type="submit">Signup</a> -->
							<button class="btn btn-link" type="submit">Continue</button>
						...
						<div class="wrap-login100-form-btn">
							...
							<button class="btn btn-link"><a href="?mod=usernotlogin&act=list">Cancel</a></button>
						</div>
	...
	if (isset($_COOKIE['msg2'])) {
		...
		echo "<script >
				$(document).ready(function(){
					swal('Code not true!', 'You clicked the button!', 'error');
				})
			</script>";
	}
