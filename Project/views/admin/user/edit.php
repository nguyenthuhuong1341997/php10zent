		 		...
		 		<div class="container">
					<div class="row main" style="width: 80%; padding: 5% 10%">
						<div class="main-login main-center">
							<h1>ADD USER</h1>
							<form class="" method="POST" action="?mod=admin&act=update_user&id=<?=$admin['id']?>">
								...
								<div class="form-group">
									...
									<div class="cols-sm-10">
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
											<input type="text" class="form-control" name="address" id="email"  value="<?=$admin['address']?>"/>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="cols-sm-10">
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
											<input type="password" class="form-control" name="confirm" id="confirm"  value="<?=$admin['password']?>"/>
										</div>
									</div>
								</div>
								<div class="form-group">
