...
<head>
    ...
    <link rel="stylesheet" href="public/sweetalert/sweetalert.js">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="?mod=usernotlogin&act=logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?mod=admin&act=list_post"><i class="fa fa-table fa-fw"></i> Post</a>
                        </li>
                        <li>
                            <a href="?mod=admin&act=list_user"><i class="fa fa-edit fa-fw"></i> User</a>
                        </li>
                        <li>
