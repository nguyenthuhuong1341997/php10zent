            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?mod=<?='list_user'?>"><i class="fa fa-dashboard fa-fw"></i>Quản lí người dùng</a>
                        </li>
                        <li>
                            <a href="?mod=<?='list_article'?>"><i class="fa fa-bar-chart-o fa-fw"></i>Quản lí bài viết<span class="fa arrow"></span></a>
